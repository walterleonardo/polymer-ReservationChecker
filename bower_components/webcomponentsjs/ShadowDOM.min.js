...
"undefined" == typeof WeakMap && !function () {
    ...
    function w(e, t) {
        try {
            return e === window && "showModalDialog" === t ? q : Object.getOwnPropertyDescriptor(e, t)
        } catch (n) {
            return q
        }
    }
        ...
        for (var i = k(t), a = 0; a < i.length; a++) {
            ...
            if ("polymerBlackList_" !== s && !(s in n || t.polymerBlackList_ && t.polymerBlackList_[s])) {
                ...
                if ("function" != typeof p.value) {
                    ...
                    A(n, s, {get: c, set: u, configurable: v, enumerable: p.enumerable})
                } else r && (n[s] = h(s))
            }
        }
    }
    ...
    e.addForwardingProperties = c, e.assert = n, e.constructorTable = R, e.defineGetter = C, e.defineWrapGetter = H, e.forwardMethodsToWrapper = x, e.isIdentifierName = p, e.isWrapper = S, e.isWrapperFor = b, e.mixin = r, e.nativePrototypeTable = P, e.oneOf = i, e.registerObject = y, e.registerWrapper = v, e.rewrap = D, e.setWrapper = j, e.unsafeUnwrap = N, e.unwrap = O, e.unwrapIfNeeded = L, e.wrap = T, e.wrapIfNeeded = _, e.wrappers = W
}(window.ShadowDOMPolyfill), function (e) {
    "use strict";
    function t(e, t, n) {
    ...
    n.prototype = {
        calcEditDistances: function (e, t, n, r, o, i) {
            for (var a = i - o + 1, s = n - t + 1, c = new Array(a), u = 0; u < a; u++)c[u] = new Array(s), c[u][0] = u;
            for (var l = 0; l < s; l++)c[0][l] = l;
            for (var u = 1; u < a; u++)for (var l = 1; l < s; l++)if (this.equals(e[t + l - 1], r[o + u - 1]))c[u][l] = c[u - 1][l - 1]; else {
            ...
            for (var t = e.length - 1, n = e[0].length - 1, s = e[t][n], c = []; t > 0 || n > 0;)if (0 != t)if (0 != n) {
                ...
                u = p < d ? p < l ? p : l : d < l ? d : l, u == l ? (l == s ? c.push(r) : (c.push(o), s = l), t--, n--) : u == p ? (c.push(a), t--, s = p) : (c.push(i), n--, s = d)
            ...
            for (var w = this.spliceOperationsFromEditDistances(this.calcEditDistances(e, n, s, c, u, l)), h = void 0, m = [], v = n, g = u, b = 0; b < w.length; b++)switch (w[b]) {
                case r:
    ...
    function a(e, n, o) {
        for (var i = Object.create(null), a = Object.create(null), s = e; s; s = s.parentNode) {
            ...
            if (c)for (var u = 0; u < c.length; u++) {
                ...
                if ((s === e || p.subtree) && ("attributes" !== n || p.attributes) && ("attributes" !== n || !p.attributeFilter || null === o.namespace && p.attributeFilter.indexOf(o.name) !== -1) && ("characterData" !== n || p.characterData) && ("childList" !== n || p.childList)) {
                    var d = l.observer;
    ...
    var l = e.setEndOfMicrotask, p = e.wrapIfNeeded, d = e.wrappers, f = new WeakMap, h = [], w = !1, m = Array.prototype.slice, v = 0;
    c.prototype = {
    ...
    function h(t, n) {
        ...
        return ne.set(t, o), w(t, o, a, i) && m(t, o, a, i) && v(t, o, a, i), J.set(t, re), $["delete"](t, null), K["delete"](t), t.defaultPrevented
    }
    ...
    function g(e, t, n, r, o) {
        ...
        for (var w = 0, m = i.length; w < m; w++) {
            var v = i[w];
            if (v.removed)h = !0; else if (!(v.type !== f || !v.capture && n === oe || v.capture && n === ae))try {
    ...
    }, de = k({initMouseEvent: M("initMouseEvent", 14)}, pe), fe = k({initFocusEvent: M("initFocusEvent", 5)}, pe), he = S("MouseEvent", ue, de), we = S("FocusEvent", ue, fe), me = Object.create(null), ve = function () {
        try {
    ...
    function w(e, t) {
        ...
        var n = t.length;
        if (1 === n)return W(t[0]);
        for (var r = W(e.ownerDocument.createDocumentFragment()), o = 0; o < n; o++)r.appendChild(W(t[o]));
        return r
    }
    ...
    S.prototype = Object.create(M.prototype), C(S.prototype, {
        appendChild: function (e) {
            ...
            var s, c = r.nextSibling, u = r.previousSibling, d = !this.invalidateShadowRenderer() && !g(e);
    ...
    var w = e.wrappers.HTMLCollection, m = e.wrappers.NodeList, v = e.getTreeScope, g = e.unsafeUnwrap, b = e.wrap, y = document.querySelector, E = document.documentElement.querySelector, S = document.querySelectorAll, M = document.documentElement.querySelectorAll, T = document.getElementsByTagName, O = document.documentElement.getElementsByTagName, N = document.getElementsByTagNameNS, j = document.documentElement.getElementsByTagNameNS, L = window.Element, _ = window.HTMLDocument || window.Document, D = "http://www.w3.org/1999/xhtml", C = {
    ...
    }), v = m[0], g = w.prototype[v], b = new WeakMap;
    ...
    }), w.prototype.webkitCreateShadowRoot && (r.prototype.webkitCreateShadowRoot = r.prototype.createShadowRoot), p(r.prototype, o), p(r.prototype, i), p(r.prototype, s), p(r.prototype, c), p(r.prototype, u), d(w, r, document.createElementNS(null, "x")), e.invalidateRendererBasedOnAttribute = t, e.matchesNames = m, e.originalMatches = g, e.wrappers.Element = r
}(window.ShadowDOMPolyfill), function (e) {
    "use strict";
    function t(e) {
        switch (e) {
    ...
    var w = e.wrappers.Element, m = e.defineGetter, v = e.enqueueMutation, g = e.mixin, b = e.nodesWereAdded, y = e.nodesWereRemoved, E = e.registerWrapper, S = e.snapshotNodeList, M = e.unsafeUnwrap, T = e.unwrap, O = e.wrap, N = e.wrappers, j = /[&\u00A0"]/g, L = /[&\u00A0<>]/g, _ = o(["area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"]), D = o(["style", "script", "xmp", "iframe", "noembed", "noframes", "plaintext", "noscript"]), C = "http://www.w3.org/1999/xhtml", H = /MSIE/.test(navigator.userAgent), x = window.HTMLElement, R = window.HTMLTemplateElement;
    u.prototype = Object.create(w.prototype), g(u.prototype, {
        get innerHTML() {
            return s(this)
        }, set innerHTML(e) {
        ...
        append: function (e) {
            ...
            if (!this.skip) {
                for (var t = this.node, o = this.childNodes, i = a(x(t)), s = e || new WeakMap, c = B.calculateSplices(o, i), u = 0, l = 0, p = 0, d = 0; d < c.length; d++) {
                    ...
                    for (var v = f.addedCount, g = i[l] && R(i[l]), w = 0; w < v; w++) {
                        var b = o[u++], y = b.node;
    ...
    }, e.getRendererForHost = u, e.getShadowTrees = M, e.renderAllPending = s, e.getDestinationInsertionPoints = v, e.visual = {
        insertBefore: n,
        remove: r
    }
}(window.ShadowDOMPolyfill), function (e) {
    ...
    var u = e.GetElementsByInterface, l = e.wrappers.Node, p = e.ParentNodeInterface, d = e.NonElementParentNodeInterface, f = e.wrappers.Selection, h = e.SelectorsInterface, w = e.wrappers.ShadowRoot, m = e.TreeScope, v = e.cloneNode, g = e.defineGetter, b = e.defineWrapGetter, y = e.elementFromPoint, E = e.forwardMethodsToWrapper, S = e.matchesNames, M = e.mixin, T = e.registerWrapper, O = e.renderAllPending, N = e.rewrap, j = e.setWrapper, L = e.unsafeUnwrap, _ = e.unwrap, D = e.wrap, C = e.wrapEventTargetMethods, H = (e.wrapNodeList,
        new WeakMap);
    t.prototype = Object.create(l.prototype), b(t, "documentElement"), b(t, "body"), b(t, "head"), g(t, "activeElement", function () {
